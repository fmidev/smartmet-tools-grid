...
void readConfigFile(const char* configFile)
{
  try
  {
    const char *configAttribute[] =
    {
        ...
        "smartmet.service.grid.content-server.helpFile",
        ...
        "smartmet.service.grid.content-server.data-source.memory.dataSortingFlags",
    ...
    mConfigurationFile.getAttributeValue("smartmet.service.grid.content-server.helpFile", mHelpFile);
    ...
    mConfigurationFile.getAttributeValue("smartmet.service.grid.content-server.data-source.memory.dataSortingFlags", mDataSortingFlags);
