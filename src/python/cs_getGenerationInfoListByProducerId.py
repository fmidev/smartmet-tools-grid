...
if len(sys.argv) != 3:
  print("USAGE: python cs_getGenerationInfoListByProducerId.py <sessionId> <producerId>")
  sys.exit(-1)
...
res,generationList = contentServer.getGenerationInfoListByProducerId(sessionId,producerId)
