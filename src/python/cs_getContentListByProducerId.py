...
if len(sys.argv) != 6:
  print("USAGE: python cs_getContentListByProducerId.py <sessionId> <producerId> <startFileId> <startMessageIndex> <maxRecords>")
  sys.exit(-1)
...
producerId = int(sys.argv[2])
startFileId = int(sys.argv[3])
startMessageIndex = int(sys.argv[4])
maxRecords = int(sys.argv[5])

res,contentList = contentServer.getContentListByProducerId(sessionId,producerId,startFileId,startMessageIndex,maxRecords)
