...
void saveMessageImage(const char *imageFile,const GRID::Message *message,T::ParamValue minValue,T::ParamValue maxValue,T::InterpolationMethod interpolationMethod,double scaleFactor,uint valueLevels,uint flags)
{
  try
  {
