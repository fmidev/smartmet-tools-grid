...
void print_usage()
{
  ...
  printf("\n");
  printf("USAGE :\n");
  printf("  grid_getIsobandImageByBox <gridFile> <msgIndex> <x1> <y1> <x2> <y2> <multiplier>\n");
...
int main(int argc, char **argv)
{
  try
  {
    ...
    double mp = atof(argv[7]);
    bool rotate = (bool)atoi(argv[8]);
    char *jpgFile = argv[9];
    ...
    message->getGridIsobandsByBox(lowValues,highValues,urn,x1,y1,x2,y2,attributeList,contours);
