/*! \file
 *  \brief Content Server client: deletes all content records belonging to the given producerId from the Content Server.
 */
...
int main(int argc, char *argv[])
{
  try
  {
    ...
    int result = service->deleteContentListByProducerId(sessionId,producerId);
