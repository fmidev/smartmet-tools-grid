...
int main(int argc, char *argv[])
{
  try
  {
    if (argc < 5)
    {
      fprintf(stdout,"USAGE: cs_getContentLevelListByGenerationGeometryAndLevelId <sessionId> <generationId> <geometryId> <levelId> [[-http <url>]|[-redis <address> <port> <tablePrefix>]]\n");
      return -1;
    }
