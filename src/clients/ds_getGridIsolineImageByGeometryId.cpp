...
int main(int argc, char *argv[])
{
  try
  {
    ...
    if (argc < 9)
    {
      ...
      fprintf(stdout,"  ds_getGridIsolineImageByGeometryId <sessionId> <fileId> <messageIndex> <geometryId>\n");
    ...
    int result = dataServer.getGridIsolinesByGeometryId(sessionId,fileId,messageIndex,values,geometryId,attributeList,contours);
