/*! \file
 *  \brief Content Server client: retrieve parameter key list for a given generation ID.
 */
...
int main(int argc, char *argv[])
{
  try
  {
    if (argc < 4)
    {
      fprintf(stdout,"USAGE: cs_getContentParamListByGenerationId <sessionId> <generationId> <paramKeyType> [[-http <url>]|[-redis <address> <port> <tablePrefix> <password>]]\n");
      return -1;
    }
