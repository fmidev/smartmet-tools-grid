/*! \file
 *  \brief Content Server client: retrieve the list of content records with invalid integrity.
 */
...
int main(int argc, char *argv[])
{
  try
  {
    if (argc < 2)
    {
      fprintf(stdout,"USAGE: cs_getContentListOfInvalidIntegrity <sessionId> [[-http <url>]|[-redis <address> <port> <tablePrefix> <password>]]\n");
      return -1;
    }
