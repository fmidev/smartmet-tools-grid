/*! \file
 *  \brief Content Server client: retrieves the list of unique (producerName, geometryId) pairs available in the Content Server.
 */
...
int main(int argc, char *argv[])
{
  try
  {
    if (argc < 2)
    {
      fprintf(stdout,"USAGE: cs_getProducerNameAndGeometryList <sessionId> [[-http <url>]|[-redis <address> <port> <tablePrefix> <password>]]\n");
      return -1;
    }
