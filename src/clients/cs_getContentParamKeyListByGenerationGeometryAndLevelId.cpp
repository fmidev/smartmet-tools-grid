...
int main(int argc, char *argv[])
{
  try
  {
    if (argc < 5)
    {
      fprintf(stdout,"USAGE: cs_getContentParamListByGenerationGeometryAndLevelId <sessionId> <generationId> <geometryId> <levelId> <paramKeyType> [[-http <url>]|[-redis <address> <port> <tablePrefix>]]\n");
      return -1;
    }
