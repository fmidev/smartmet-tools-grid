/*! \file
 *  \brief Content Server client: deletes multiple file registration records identified by a list of fileIds from the Content Server.
 */
...
int main(int argc, char *argv[])
{
  try
  {
    if (argc < 3)
    {
      fprintf(stdout,"USAGE: cs_deleteFileInfoListByFileIdList <sessionId> <fileId1> [<fileId2> .. <fileIdN>] [[-http <url>]|[-redis <address> <port> <tablePrefix> <password>]]\n");
      return -1;
    }
