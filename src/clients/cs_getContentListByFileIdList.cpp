/*! \file
 *  \brief Content Server client: queries and prints all content records associated with a list of fileIds from the Content Server.
 */
...
int main(int argc, char *argv[])
{
  try
  {
    if (argc < 3)
    {
      fprintf(stdout, "USAGE: cs_getContentListByFileIdList <sessionId> <fileId> [<fileId> .. <fileId>] [[-http <url>]|[-redis <address> <port> <tablePrefix> <password>]]\n");
      return -1;
    }
