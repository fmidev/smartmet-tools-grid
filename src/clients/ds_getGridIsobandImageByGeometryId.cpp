...
int main(int argc, char *argv[])
{
  try
  {
    ...
    if (argc < 9)
    {
      ...
      fprintf(stdout,"  ds_getGridIsobandImage <sessionId> <fileId> <messageIndex> <geometryId> <multiplier> \n");
    ...
    uint geometryId = toInt64(argv[4]);
    ...
    int result = dataServer.getGridIsobandsByGeometryId(sessionId,fileId,messageIndex,lowValues,highValues,geometryId,attributeList,contours);
