/*! \file
 *  \brief Content Server client: registers a single content record (fileId, messageIndex, producerId, generationId, forecast time, parameter, level, sourceId, flags) in the Content Server.
 */
