/*! \file
 *  \brief Content Server client: registers a grid file together with an inline list of content records (each specified with -m messageIndex timestamp fmiParamId) via the CORBA Content Server.
 */
