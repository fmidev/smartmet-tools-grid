/*! \file
 *  \brief Content Server client: queries and prints a paginated list of all content records starting at a given fileId and messageIndex, up to maxRecords.
 */
...
int main(int argc, char *argv[])
{
  try
  {
    if (argc < 5)
    {
      fprintf(stdout,"USAGE: cs_getContentList <sessionId> <startFileId> <startMessageIndex> <maxRecords> [[-http <url>]|[-redis <address> <port> <tablePrefix> <password>]]\n");
      return -1;
    }
