/*! \file
 *  \brief Data Server client: render a time-interpolated isoband-filled contour image projected onto a specified geometry.
 */
...
int main(int argc, char *argv[])
{
  try
  {
    ...
    if (argc < 13)
    {
      ...
      fprintf(stdout,"  ds_getGridIsobandImageByTimeAndGeometry <sessionId> <fileId1> <msgIdx1> <fileId2> <msgIdx2> <gridTime>\n");
    ...
    int result = dataServer.getGridIsobandsByTimeAndGeometry(sessionId,fileId1,messageIndex1,fileId2,messageIndex2,timestamp,lowValues,highValues,attributeList,modificationOperation,modificationParameters,contours);
