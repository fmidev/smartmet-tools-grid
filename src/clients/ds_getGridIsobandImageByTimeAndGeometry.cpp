...
int main(int argc, char *argv[])
{
  try
  {
    ...
    int result = dataServer.getGridIsobandsByTimeAndGeometry(sessionId,fileId1,messageIndex1,fileId2,messageIndex2,timestamp,lowValues,highValues,attributeList,contours);
